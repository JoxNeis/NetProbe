...
class Aes128GcmEncryptor extends AbstractEncryptor
{
    private const CIPHER  = 'aes-128-gcm';
    private const TAG_LEN = 16;

    /**
     * GCM produces an authentication tag that must be stored alongside
     * the ciphertext for later verification.
     *
